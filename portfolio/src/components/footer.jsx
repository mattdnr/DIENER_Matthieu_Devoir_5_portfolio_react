                ...
                <div class="col p-2">
                    <address>
                        <p>
                            ...
                            <span>10 20 30 40 50</span><br />
                            <span>john.doe@gmail.com</span><br />
                        </p>
                    </address>
                    <div class="social-links">
                        <a href="https://github.com/github-john-doe" target="_blank" rel="nofollow noopener noreferrer">
                            <svg className="mx-2 text-secondary" xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" fill="currentColor" class="bi bi-github" viewBox="0 0 16 16" aria-label="Github">
                        ...
                        <a href="https://x.com" target="_blank" rel="nofollow noopener noreferrer">   
                            <svg className="mx-2 text-secondary" xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" fill="currentColor" class="bi bi-twitter-x" viewBox="0 0 16 16" aria-label="X-twitter">
                                <path d="M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865z"/>
                            </svg>
                        </a>
                        <a href="https://www.linkedin.com" target="_blank" rel="nofollow noopener noreferrer">
                            <svg className="mx-2 text-secondary" xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" fill="currentColor" class="bi bi-linkedin" viewBox="0 0 16 16" aria-label="LinkedIn">
