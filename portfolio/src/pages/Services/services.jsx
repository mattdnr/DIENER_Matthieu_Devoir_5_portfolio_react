                ...
                <div className="row g-4">
                    <div className="col-12 col-md-4">
                        <Card className="h-100">
                            <CardBody className="text-center">
                                <Card.Title>
                                    <svg xmlns="http://www.w3.org/2000/svg" width=" 1.5em" height=" 1.5em"  fill="currentColor" className="bi bi-brush text-primary m-4" viewBox="0 0 16 16" aria-hidden='true'>
                    ...
                    <div className="col-12 col-md-4">
                        <Card className="h-100">
                            <CardBody className="text-center">
                                <Card.Title>
                                    <svg xmlns="http://www.w3.org/2000/svg" width=" 1.5em" height=" 1.5em" fill="currentColor" class="bi bi-code-slash text-primary m-4" viewBox="0 0 16 16" aria-hidden="true">
                    ...
                    <div className="col-12 col-md-4">
                        <Card className="h-100">
                            <CardBody className="text-center">
                                <Card.Title>
                                    <svg xmlns="http://www.w3.org/2000/svg" width=" 1.5em" height=" 1.5em" fill="currentColor" class="bi bi-search text-primary m-4" viewBox="0 0 16 16" aria-hidden='true'>
